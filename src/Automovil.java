...
// puede ser publica o simplemente class que es igual que default
    ...
    private static String colorPatente="Naranja";  //staticdefine que es un metodo de la clase y al modificarlo cambia a todos los de la clase
    ...
    */
    ...
    public Automovil(String fabricante, String modelo, String color, double cilindrada, int tanque) {
...
// metodos de funcionalidad de la clase
    ...
    public String verDetalle(){   // static se usa cuando los metodos pueden ser invocados sin instanciar la clase
      ...
      que retorna despues del public*/
        ...
        return  "\nauto.Id: "+this.id+
                ...
                "\nauto.modeloe: " + this.modelo +
                "\nauto.color: " + this.color +
                "\nauto.cilindrada: " + this.cilindrada+
                "\ncolorPatente STATIC OJO: "+colorPatente;  // color patente al ser estatica no permite asociarla a this sino que pertenece a todos los objetos de esta clase
    ...
    public float calcularConsumo(int km, float gastoGas){
        return km/(this.tanque * gastoGas);
    }
    public float calcularConsumo(int km, int gastoGas){
        return km/(this.tanque *(gastoGas/100f) );
    }
